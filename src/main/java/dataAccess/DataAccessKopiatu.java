 ...
 */
public class DataAccessKopiatu  {
	...
	ConfigXML c=ConfigXML.getInstance();
     ...
     public DataAccessKopiatu(boolean initializeMode)  {
	...
	public DataAccessKopiatu()  {	
		 this(false);
	}
	
	
	public DataAccessKopiatu(EntityManager dbb) {
...
public void open(boolean initializeMode){
	...
	public boolean gertaeraEzabatu(Event ev) {
		...
		resultB = questionList(resultB, listQ);
		if(!resultB) {
			return false;
	...
	private boolean questionList(boolean resultB, List<Question> listQ) {
