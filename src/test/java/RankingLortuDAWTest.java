...
public class RankingLortuDAWTest {
	 ...
	 * metodo devuelve la lista con el �nico elemento.
	 */
	 ...
	 * Por ultimo comprueba que los elementos que devuelve el m�todo estan ordenados
	...
	public void testRankingLortuVariosRegistros() {
		...
		//A�ado los usuarios a una lista de tal forma que no esten ordenados por ganancias
