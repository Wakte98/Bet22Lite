...
public class GertaerakKopiatuDAWTest {
    ...
    public void testGertaerakKopiatu_test1() {
		...
		// Agregar elementos a resultList para simular una lista NO vac�a
    ...
    public void testGertaerakKopiatu_test2() {
        ...
        // Instanciar la clase que contiene el m�todo 
        DataAccessKopiatu sut = new DataAccessKopiatu(db);
        
        // Llamar al m�todo que queremos probar
        boolean result = sut.gertaerakKopiatu(event, future);
  
        // Verificar que el m�todo retorna true si date > hoy
        assertTrue(result);
...
//    	        Event event1 = new Event();
        ...
        // Verificar que el m�todo retorna true por lo que se copia correctamente el evento
        assertTrue(result);
